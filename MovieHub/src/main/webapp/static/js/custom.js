...
function init_Contact () {
    ...
    //1. Fullscreen map init
                //Init map
                    var mapOptions = {
                        scaleControl: true,
                        center: new google.maps.LatLng(23.1321706,113.3247953),
                        zoom: 5,
...
function init_MoviePage () {
    ...
    //9. Init map with several markers on.
                    ...
                    var mapOptions = {
                        scaleControl: true,
                        center: new google.maps.LatLng(23.0931011,113.3296857),
                        zoom: 15,
                        navigationControl: false,
                        streetViewControl: false,
                        mapTypeControl: false,
                    ...
                    var markerB = new google.maps.Marker({
                        map: map,
                        position: new google.maps.LatLng(23.0610277,113.389835)
                    });

                    var markerC = new google.maps.Marker({
                        map: map,
                        position: new google.maps.LatLng(23.1321706,113.3247953)
                    });

                    var markerD = new google.maps.Marker({
                        map: map,
                        position: new google.maps.LatLng(23.1352569,113.2793161)
                    });

                    var markerE = new google.maps.Marker({
                        map: map,
                        position: new google.maps.LatLng(23.0995252,113.3252345)
                    });
                    ...
                    //Creates the information to go in the pop-up info box.
                    var boxTextA = document.createElement("div");
                    boxTextA.innerHTML = '<span class="pop_up_box_text">哈艺时尚影城（石榴岗路店），广州市海珠区石榴岗</span>';
                    ...
                    boxTextB.innerHTML = '<span class="pop_up_box_text">金逸珠江影城（大学城店），广州市番禺区GOGO新天地二期二层</span>';
                    ...
                    boxTextC.innerHTML = '<span class="pop_up_box_text">广州飞扬影城（正佳IMAX店），天河路228号正佳广场七楼（体育中心站 D出口）</span>';
                    ...
                    boxTextD.innerHTML = '<span class="pop_up_box_text">广州保利国际影城（中环店）, 广州市越秀区建设大马路18号中环广场南楼五层</span>';
                    ...
                    boxTextE.innerHTML = '<span class="pop_up_box_text">广州五一影城（四季天地店），广州市海珠区赤岗北路118号四季天地3楼</span>';
